...
while true do
    ...
    print("ACTIVE PRIORITY: "..activePriority)
    ...
    print("INFO: "..tostring(activePriority == "INFO"))
    print("WARNING: "..tostring(activePriority == "WARNING"))
    print("FAIL: "..tostring(activePriority == "FAIL"))
    print("ALARM: "..tostring(activePriority == "ALARM"))
